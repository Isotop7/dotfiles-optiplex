...
alias runCruxBuild="rm -f ~/qemu/images/crux_diff.qcow2; qemu-img create -f qcow2 -F qcow2 -b crux.qcow2 crux_diff.qcow2; qemu-system-x86_64 -enable-kvm -smp 4 -hda ~/qemu/images/crux_diff.qcow2 -m 4096"
