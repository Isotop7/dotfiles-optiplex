...
alias runCruxBuild="rm -f ~/qemu/images/crux_diff.qcow2; qemu-img create -f qcow2 -F qcow2 -b crux.qcow2 crux_diff.qcow2; qemu-system-x86_64 -enable-kvm -hda ~/qemu/images/crux_diff.qcow2 -m 2048"
alias runCruxBase="qemu-system-x86_64 -enable-kvm -hda ~/qemu/images/crux.qcow2 -m 2048"
